...
export default function StorefrontCatalogoPage() {
  ...
  return (
    <div className="flex flex-col gap-8 min-h-screen">
      ...
      {/* Cabecera y Buscador */}
      <section className="bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-gray-100 flex flex-col gap-6">
        <div>
          <h1 className="text-3xl sm:text-4xl font-black text-gray-900 mb-2">Nuestro Catálogo</h1>
          <p className="text-gray-500">Encontrá tus platos favoritos en un solo lugar.</p>
        </div>
      ...
      <section className="w-full relative group">
        ...
        <button 
          ...
          className="absolute left-0 top-1/2 -translate-y-1/2 -ml-4 z-10 bg-white border border-gray-200 shadow-md rounded-full p-2 text-gray-600 hover:text-green-main hover:border-green-main transition-all hidden md:flex opacity-0 group-hover:opacity-100"
        >
          <ChevronLeft size={20} />
        </button>
        ...
        <div 
          ...
          className="flex overflow-x-auto pb-4 gap-3 hide-scrollbar px-2 scroll-smooth"
        >
          <button
          ...
          {categorias.map((cat) => (
            <button
              ...
              className={`whitespace-nowrap px-6 py-2.5 rounded-full font-bold text-sm transition-all shadow-sm snap-start shrink-0 border ${selectedCategoria === cat.id
                  ? "bg-green-main text-white border-green-main"
                  : "bg-white text-gray-600 border-gray-200 hover:border-green-main hover:text-green-main"
                }`}
            >
        ...
        <button 
          ...
          className="absolute right-0 top-1/2 -translate-y-1/2 -mr-4 z-10 bg-white border border-gray-200 shadow-md rounded-full p-2 text-gray-600 hover:text-green-main hover:border-green-main transition-all hidden md:flex opacity-0 group-hover:opacity-100"
        >
